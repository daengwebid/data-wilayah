...
--
-- Host: localhost
-- Generation Time: Jan 12, 2016 at 02:39 AM
...
INSERT INTO `kabupaten` (`kabupaten_id`, `provinsi_id`, `nama_kabupaten`) VALUES
...
CREATE TABLE IF NOT EXISTS `kecamatan` (
  ...
  KEY `districts_regency_id_index` (`kabupaten_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
